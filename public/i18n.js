...
const I18N = {
  en: {
    ...
    spent: 'Spent', payments: 'Expenditures', add_payment: 'Add expenditure', payee: 'Payee',
    no_projects: 'No projects yet.', no_payments: 'No expenditures recorded yet.',
    ...
    spent_from_payments: 'Spent from received payments', balance_in_hand: 'Remaining in hand',
    overspent_received: 'Over the received amount', spent_from_this: 'Spent from it',
    left_from_this: 'Left from it', fully_used: 'Fully used',
    // payment categories
    ...
    api_access: 'Bot & API access', add_token: 'Create access token', token_name: 'Token name',
    token_name_hint: 'e.g. Telegram bot', token_created_title: 'Access token created',
    token_created_msg: 'Copy this token now — it will not be shown again. Give it to your bot/agent.',
    last_used: 'Last used', never_used: 'Never used', copy: 'Copy', copied: 'Copied ✓', done: 'Done',
    api_hint: 'Tokens let an external bot (e.g. your Telegram agent) add expenses and payments as you. Each person should create their own token.',
    // misc
  ...
  ar: {
    ...
    spent: 'المصروف', payments: 'المنصرفات', add_payment: 'إضافة منصرفات', payee: 'المستفيد',
    no_projects: 'لا توجد مشاريع بعد.', no_payments: 'لا توجد منصرفات مسجلة بعد.',
    ...
    spent_from_payments: 'المصروف من الدفعات المستلمة', balance_in_hand: 'المتبقي من الدفعات',
    overspent_received: 'تجاوز المبلغ المستلم', spent_from_this: 'المصروف منها',
    left_from_this: 'المتبقي منها', fully_used: 'مستهلكة بالكامل',
    ...
    api_access: 'ربط الروبوت (API)', add_token: 'إنشاء رمز وصول', token_name: 'اسم الرمز',
    token_name_hint: 'مثال: روبوت تيليجرام', token_created_title: 'تم إنشاء رمز الوصول',
    token_created_msg: 'انسخ هذا الرمز الآن — لن يظهر مرة أخرى. أعطه للروبوت الخاص بك.',
    last_used: 'آخر استخدام', never_used: 'لم يُستخدم بعد', copy: 'نسخ', copied: 'تم النسخ ✓', done: 'تم',
    api_hint: 'رموز الوصول تسمح لروبوت خارجي (مثل وكيل تيليجرام) بإضافة المصاريف والدفعات باسمك. كل شخص ينشئ رمزه الخاص.',
